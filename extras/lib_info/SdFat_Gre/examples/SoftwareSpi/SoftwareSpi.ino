...
#include <SPI.h>
#include "SdFat_Gre.h"
#if ENABLE_SOFTWARE_SPI_CLASS  // Must be set in SdFat_Gre/SdFat_Gre_SdFatConfig.h
//
...
#error ENABLE_SOFTWARE_SPI_CLASS must be set non-zero in SdFat_Gre/SdFat_Gre_SdFatConfig.h
