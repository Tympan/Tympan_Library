...
**Note**: These instructions were based on the *Arduino IDE 1.8.2* and *Teensyduino 1.36*. If you have different versions of either of these or download different versions, the program may or may not function as expected. You may revert or upgrade to the stated versions or check for solutions on the [Typman Forum](https://forum.typman.org/).
