// AveragingFFT_FD
//
// Analyze an in-coming audio signal via an FFT.  This example applies time-averaging
// to smooth the FFT values.
//
...
//    * Smooth the FFT values with previous FFT values
//
// The averaging is a first order IIR lowpass filter
//
// This example code is in the public domain (MIT License)

#include <Tympan_Library.h>
#include "AudioAnalyzeFFT_FD_F32.h"  //the local file holding your custom function
