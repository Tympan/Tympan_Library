...
*   Tympan_Test_BLE
*
*   Created: Chip Audette, OpenAudio, May 2024
*   Purpose: Test the generic BLE interface (both BC127 and nRF52840), which should cover Tympan
*            Rev D up through Rev F.  Includes App interaction.
*
*   TympanRemote App: https://play.google.com/store/apps/details?id=com.creare.tympanRemote
*   
*   If using Tympan RevD, set the Arduino IDE to compile for Teensy 3.6
*   If using Tympan RevE or RevF, set the Arduino IDE to compile for Teensy 4.1
*   
...
Tympan                    myTympan(TympanRev::F,audio_settings);          //only TympanRev::F or TympanRev:E or TympanRev:D
