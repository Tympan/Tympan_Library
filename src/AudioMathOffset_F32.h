 ...
 * Purpose: Add a fixed DC offset (single value, not vector) to the audio data
...
class AudioMathOffset_F32 : public AudioStream_F32
{
  ...
  public:
    AudioMathOffset_F32(void) : AudioStream_F32(2, inputQueueArray_f32) {};
	AudioMathOffset_F32(const AudioSettings_F32 &settings) : AudioStream_F32(2, inputQueueArray_f32) {};
