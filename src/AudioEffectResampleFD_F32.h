...
#ifndef _AudioEffectResample_FD_F32_h
#define _AudioEffectResample_FD_F32_h
...
// domain.
class AudioEffectResample_FD_F32 : public AudioFreqDomainBase_FD_F32   //AudioFreqDomainBase_FD_F32 is in Tympan_Library
{
  public:
    //constructor
    AudioEffectResample_FD_F32(const AudioSettings_F32 &settings) : AudioFreqDomainBase_FD_F32(settings) {};
    ...
    void processAudioFD(float32_t *complex_2N_buffer) override {
      ...
      //Serial.println("AudioEffectResample_FD_F32: processAudioFD: here!");
    };   
